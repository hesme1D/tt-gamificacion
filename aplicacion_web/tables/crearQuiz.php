                ...
                <div class="x_panel">
                  ...
                  <div class="x_content"> <!--Text area-->
                      ...
                      <div class="btn-toolbar editor" data-role="editor-toolbar" data-target="#editorOne">
                        ...
                        <input type="button" align="center" class="btn btn-success" name="guardar"  value="Guardar Historia" onclick="crearActividad(<?php echo $_GET['idHistoria']?>,<?php echo $_GET['tipo']?>); guardarTextQuiz();">
