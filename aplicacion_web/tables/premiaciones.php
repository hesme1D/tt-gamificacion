  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
        ...
        <div class="right_col">
          <div class="row">
            <h3 align="center"><i class="fa fa-trophy"></i> Premios obtenidos </h3>
            <div class="col-md-12"></div>
            <?php 
              $QueryPremios = "SELECT * FROM premios_asignados WHERE id_usuario = '$idUsuario'";
              $QueryRes = mysqli_query($Con, $QueryPremios);
              while($renglon = mysqli_fetch_array($QueryRes)){
            ?>
              ...
              <div class="col-md-6 col-sm-6 col-lg-3" >
                <div class="animated flipInY">
                  <div class="tile-stats" align="center">
                    <br>
                    <img src="<?php echo $renglon['imagen']?>" height="100px" width="100px">
                    <br>
                    <br>
                    <h5 style="color: #c1aa5c; font-family: monospace;"><?php echo $renglon['premio']?></h5>
                  </div>
                </div>
              </div>
            ...
            <!-- premios retos -->
            <?php 
              $QueryPremiosR = "SELECT * FROM premios_retos WHERE id_usuario = '$idUsuario'";
              $QueryRetosP = mysqli_query($Con, $QueryPremiosR);
              while($renglonP = mysqli_fetch_array($QueryRetosP)){
            ?>
            <div class="col-md-6 col-sm-6 col-lg-3" style="height: 100px;">
              <div class="animated flipInY">
                <div class="tile-stats" align="center">
                  <br>

                  <img src="<?php echo $renglonP['imagen']?>" height="100px" width="100px">
                  <br>
                  <br>
                  <h5 style="color: #c1aa5c; font-family: monospace;"><?php echo $renglonP['premio']?></h5>
                </div>
              </div>
            </div>
                <br>
